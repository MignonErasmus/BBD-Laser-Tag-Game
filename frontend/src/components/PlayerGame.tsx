...
export const PlayerGame = ({ playerName, gameCode, markerId }: PlayerGameProps) => {
  ...
  const handleShoot = () => {
    if (!socket || reloading || isEliminated || currentTarget === null || !gameStarted) {
  ...
  return (
    <div className="relative min-h-[calc(100vh-7rem)] bg-gradient-to-br from-blue-900 via-slate-900 to-cyan-900 overflow-hidden">
      {!gameStarted && (
